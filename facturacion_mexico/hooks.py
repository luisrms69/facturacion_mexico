		...
		"filters": [
			[
				...
				[
					...
					"Sales Invoice-fm_ereceipt_mx",
					"Sales Invoice-fm_ereceipt_section",
					"Sales Invoice-fm_ereceipt_summary_html",
...
doc_events = {
	...
	"Sales Invoice": {
		"before_validate": [
			...
			# Ventas extranjeras — Fase 1 two-phase: blanquear income_account antes del controller
			"facturacion_mexico.ventas_extranjeras.ruteo_ingreso.before_validate",
		],
		"validate": [
			...
			# Ventas extranjeras — Fase 2 two-phase: reaplicar cuenta de ingreso extranjera + fail-closed
			"facturacion_mexico.ventas_extranjeras.ruteo_ingreso.validate",
		],
